...
A failed refresh keeps whatever was cached before. A root that is briefly unreachable should not cost a verifier the keys it already had, and the entry ages out on its own if the outage lasts.
